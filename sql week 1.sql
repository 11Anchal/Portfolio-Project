...
#final not complete yet
with sas as (with cte as (select sales.customer_id,product_id,order_date from sales 
left join members on sales.customer_id=members.customer_id)
select customer_id,order_date,product_name,price from cte
